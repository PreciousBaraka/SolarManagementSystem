...
CREATE TABLE `users` (
    ...
    `userType` ENUM('ADMIN', 'MANAGER', 'INSTALLER', 'INVENTORY_OFFICER') NOT NULL DEFAULT 'INVENTORY_OFFICER',
...
-- AddForeignKey
ALTER TABLE `stock_out` ADD CONSTRAINT `stock_out_customerId_fkey` FOREIGN KEY (`customerId`) REFERENCES `customers`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `installation_sites` ADD CONSTRAINT `installation_sites_installerId_fkey` FOREIGN KEY (`installerId`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `installation_sites` ADD CONSTRAINT `installation_sites_customerId_fkey` FOREIGN KEY (`customerId`) REFERENCES `customers`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
